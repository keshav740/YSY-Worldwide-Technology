...
import { FaWhatsapp, FaCode, FaAppStoreIos, FaLinkedin, FaInstagram, FaFacebook, FaPhone } from "react-icons/fa";
    ...
    <div className="w-full bg-transparent text-gray-200 shadow-lg p-[15px] py-10">
      <div className="w-full flex flex-col items-center justify-center m-auto">
        <div className="w-full flex flex-col md:flex-row items-start md:items-center justify-around flex-wrap">
          ...
          <div className="min-w-[200px] h-auto flex flex-col items-start justify-start text-left">
           ...
           <Link href="/services/web-development"> 
            <p className="flex flex-row items-center my-[15px] cursor-pointer text-pink-500">
              <FaCode />
              <span className="text-[15px] ml-[6px] text-white">Web Design & Development</span>
            </p>
            </Link>
            <Link href="/services/app-development"> 
            <p className="flex flex-row items-center my-[15px] cursor-pointer text-purple-600">
              <FaAppStoreIos />
              <span className="text-[15px] ml-[6px] text-white">App Development</span>
            </p>
            </Link>
            ...
            <p className="flex flex-row items-center my-[15px] cursor-pointer text-red-500">
              ...
              <span className="text-[15px] ml-[6px] text-white">Social Media Marketing</span>
            </p>
            </Link>
            <Link href="/services/iso-certification"> 
            <p className="flex flex-row items-center my-[15px] cursor-pointer text-blue-500">
              <TbFileCertificate />
              <span className="text-[15px] ml-[6px] text-white">ISO/ICV And Further Certifications</span>
            </p>
            </Link>
            <Link href="/services/compliance">
            <p className="flex flex-row items-center my-[15px] cursor-pointer text-yellow-500">
            <MdOutlineMiscellaneousServices />
              <span className="text-[15px] ml-[6px] text-white">Compliance Services</span>
            </p>
            </Link>
            <Link href="/services/brand-development">
            <p className="flex flex-row items-center my-[15px] cursor-pointer text-yellow-500">
            <MdOutlineMiscellaneousServices />
              <span className="text-[15px] ml-[6px] text-white">Brand Development</span>
            </p>
            </Link>
          </div>
          ...
          <div className="min-w-[200px] h-auto flex flex-col items-start justify-start text-left">
            ...
            <p className="flex flex-row items-center my-[15px] cursor-pointer text-purple-500">
              <FaClock />
              <span className="text-[15px] ml-[6px] text-white">Mon – Sat 10:00pm - 8:00pm</span>
            </p>
            <p className="flex flex-row items-center my-[15px] cursor-pointer text-purple-500">
              <FaPhone />
              <span className="text-[15px] ml-[6px] text-white">+91 7497876899</span>
            </p>
            <p className="flex flex-row items-center my-[15px] cursor-pointer text-red-600">
              <CgMail />
              <span className="text-[15px] ml-[6px] text-white">ysyworldwidetechnology@gmail.com</span>
            </p>
            <p className="flex flex-row items-center my-[15px] cursor-pointer text-red-600">
              <CgMail />
              <span className="text-[15px] ml-[6px] text-white">info@ysyworldwidetechnology.com</span>
            </p>
            <p className="flex flex-row items-center my-[15px] cursor-pointer text-yellow-500">
              <CiLocationOn />
              <span className="text-[15px] ml-[6px] text-white">Internet city, Dubai</span>
            </p>
          </div>
          {/* Your social media section */}
          <div className="min-w-[200px] h-auto flex flex-col items-start justify-start text-left">
            <p className="flex flex-row items-center my-[15px] cursor-pointer text-red-600" onClick={handleIconClick}>
              <CgMail style={{ pointerEvents: "none" }} />
            </p>
            <p className="flex flex-row items-center my-[15px] cursor-pointer text-blue-600">
              <Link href="https://www.facebook.com/profile.php?id=100090959557942" target="_blank">
                <FaFacebook />
              </Link>
            </p>
            <p className="flex flex-row items-center my-[15px] cursor-pointer text-pink-700">
              <Link href="https://www.instagram.com/stories/ysyworldwidetechnology/3189397138998492317/" target="_blank">
                <FaInstagram />
              </Link>
            </p>
            <p className="flex flex-row items-center my-[15px] cursor-pointer text-blue-700">
              <Link href="https://www.linkedin.com/feed/?trk=homepage-basic_sign-in-submit" target="_blank">
                <FaLinkedin />
              </Link>
            </p>
        ...
        <div className="mb-[20px] mt-4 py-5 text-[15px] text-center">
          &copy; YSY WorldWide Technology. All rights reserved
        </div>
      </div>
    </div>
  );
